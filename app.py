...
class ResumeApp:
    ...
    def load_image(self, image_name):
        ...
        try:
            image_path = f"c:/Users/noel/Downloads/-ai/{image_name}"
    ...
    def render_home(self):
        ...
        hero_section(
            "Career Assistance",
            "Generate personalized career roadmaps, optimize your resume with advanced parsing, create professional resumes, get instant query assistance, gain career insights, and explore job opportunities"
        )
